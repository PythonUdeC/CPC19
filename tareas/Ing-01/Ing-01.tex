...
irradiación solar sobre una grilla global de latitudes y longitdes. Esta información esta dada tanto por meses como anual. La base de datos 
...
\begin{parts}
    ...
    \part \noindent Repita el analisis anterior para todos los meses del año e incluya las 12 gráficas en una misma figura.
    ...
    como aparece en la data crudo (\textit{sun$\_$raw.csv}), y repito los ejercicios de la tarea. Si es que le interesan los 
